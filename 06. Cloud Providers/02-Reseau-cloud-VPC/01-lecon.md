...
> 🧭 **Où le pratiquer concrètement ?** Ce bloc présente le VPN **conceptuellement**. Pour **monter et utiliser** un vrai VPN au quotidien — WireGuard, OpenVPN, tunnels SSH — vois la **Leçon 5 du Bloc 5** : `05. Réseautage et sécurité/05-VPN-et-tunnels-securises/`.)
