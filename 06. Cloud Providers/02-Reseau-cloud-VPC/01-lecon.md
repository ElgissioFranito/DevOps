...
> 🧭 **Où le pratiquer concrètement ?** Ce bloc présente le VPN **conceptuellement**. Pour **monter et utiliser** un vrai VPN au quotidien — WireGuard, OpenVPN — vois la **Leçon 5a du Bloc 5** : `05. Réseautage et sécurité/05a-VPN-et-acces-prive/` (et pour les tunnels ponctuels — SSH, Cloudflare Tunnel — la Leçon 5b).)
